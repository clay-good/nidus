...
| `baseline_heart_rate_bpm` | Non-pregnant HR | 70 | A | phase1 | Mahendru 2014 |
| `peak_excess_heart_rate_bpm` | HR rise to term | 15 | A | phase1 | Mahendru 2014 |
| `heart_rate_peak_week` | Week of HR peak | 32 | B | phase1 | Mahendru 2014 |
| `baseline_stroke_volume_ml` | Non-pregnant SV | 70 | B | phase1 | Sanghavi 2014 |
| `peak_excess_stroke_volume_ml` | SV rise | 15 | B | phase1 | Sanghavi 2014 |
| `baseline_svr_dyn_s_cm5` | Non-pregnant SVR | 1300 | B | phase1 | Sanghavi 2014 |
| `term_svr_dyn_s_cm5` | Term SVR | 980 | B | phase1 | Sanghavi 2014 |
| `baseline_pvr_dyn_s_cm5` | Non-pregnant PVR | 120 | C | phase2 | Robson 1989 |
| `term_pvr_dyn_s_cm5` | Term PVR | 80 | C | phase2 | Robson 1989 |
| `lv_mass_term_g` | LV mass at term | 165 | B | phase2 | Robson 1989 |
| `lv_wall_thickness_term_mm` | LV wall at term | 11 | C | phase2 | Robson 1989 |
| `aortic_diameter_term_mm` | Aortic diameter at term | 23 | C | phase3 | Sanghavi 2014 |
| `pulse_wave_velocity_term_m_per_s` | PWV at term | 8.5 | C | phase3 | Mahendru 2014 |
...
| `wbc_term_x10e9_per_l` | WBC at term | 10.5 | A | phase1 | Pitkin 1979 |
...
| `serum_albumin_term_g_per_dl` | Albumin at term | 3.3 | A | phase1 | Larsson 2008 |
| `total_protein_term_g_per_dl` | Total protein term | 6.5 | A | phase2 | Larsson 2008 |
| `serum_iron_term_ug_per_dl` | Iron at term | 70 | B | phase1 | Hytten 1980 |
| `transferrin_saturation_term_pct` | Tsat at term | 20 | B | phase2 | Hytten 1980 |
| `ferritin_term_ng_per_ml` | Ferritin at term | 15 | B | phase1 | Hytten 1980 |
| `folate_term_ng_per_ml` | Folate at term | 5 | B | phase2 | Hytten 1980 |
| `b12_term_pg_per_ml` | B12 at term | 250 | C | phase2 | Hytten 1980 |
| `esr_term_mm_per_h` | ESR at term | 55 | C | phase3 | Hytten 1980 |
...
| `baseline_gfr_ml_per_min_per_1_73m2` | Non-pregnant GFR | 100 | A | phase1 | Conrad 2001 |
| `gfr_peak_week` | Week of GFR peak | 16 | B | phase1 | Conrad 2001 |
| `gfr_logistic_rate_per_week` | Logistic rate | 0.4 | B | phase1 | Conrad 2001 |
| `renal_plasma_flow_baseline_ml_per_min` | Non-pregnant RPF | 600 | B | phase1 | Dunlop 1981 |
| `renal_plasma_flow_peak_ml_per_min` | Peak RPF | 900 | B | phase1 | Dunlop 1981 |
| `rpf_peak_week` | Week of RPF peak | 24 | B | phase1 | Dunlop 1981 |
| `filtration_fraction_term` | FF at term | 0.18 | B | phase1 | Cheung 2013 |
| `plasma_osmolality_drop_mosm_per_kg` | Osmolality drop | 10 | A | phase1 | Davison 1981 |
| `plasma_sodium_drop_meq_per_l` | Sodium drop | 5 | A | phase1 | Davison 1981 |
| `cumulative_sodium_retention_g` | Total Na retained | 1.0 | B | phase1 | Cheung 2013 |
| `bun_term_mg_per_dl` | Term BUN | 8 | A | phase1 | Cheung 2013 |
| `plasma_uric_acid_term_mg_per_dl` | Term uric acid | 4 | B | phase2 | Cheung 2013 |
| `urinary_protein_term_mg_per_24h` | 24h proteinuria | 180 | B | phase2 | Higby 1994 |
...
| `baseline_tidal_volume_ml` | Non-pregnant VT | 450 | A | phase1 | LoMauro 2015 |
| `baseline_respiratory_rate_bpm` | Non-pregnant RR | 16 | A | phase1 | LoMauro 2015 |
| `term_respiratory_rate_bpm` | Term RR | 16 | A | phase1 | LoMauro 2015 |
| `baseline_pao2_mmhg` | Non-pregnant PaO₂ | 100 | A | phase1 | Templeton 1976 |
| `baseline_arterial_ph` | Non-pregnant pH | 7.40 | A | phase1 | Lim 1976 |
| `inspiratory_capacity_term_l` | IC at term | 2.8 | B | phase2 | LoMauro 2015 |
| `total_lung_capacity_term_l` | TLC at term | 5.0 | B | phase2 | LoMauro 2015 |
| `dlco_term_ml_min_mmhg` | DLCO at term | 24 | B | phase3 | Crapo 1996 |
| `aa_gradient_term_mmhg` | A-a gradient term | 14 | C | phase3 | Templeton 1976 |
| `co2_production_term_ml_per_min` | Maternal VCO₂ | 260 | B | phase3 | LoMauro 2015 |
...
| Parameter id | What | Typical | Tier | Status | Primary citation |
| --- | --- | --- | --- | --- | --- |
| `cortisol_term_ug_per_dl` | Term plasma cortisol | 30 | B | phase2 | Carr 1981 |
| `cortisol_baseline_ug_per_dl` | Non-pregnant cortisol | 10 | A | phase2 | Carr 1981 |
| `cbg_term_mg_per_l` | CBG at term | 70 | B | phase2 | Carr 1981 |
| `free_t4_term_ng_per_dl` | Free T4 at term | 0.9 | B | phase2 | Glinoer 1997 |
| `tsh_t1_miu_per_l` | TSH in T1 | 0.6 | B | phase2 | Glinoer 1997 |
| `tsh_term_miu_per_l` | TSH at term | 2.0 | B | phase2 | Glinoer 1997 |
| `prolactin_term_ng_per_ml` | Prolactin at term | 200 | B | phase2 | Tyson 1972 |
| `aldosterone_term_ng_per_dl` | Aldosterone term | 40 | B | phase2 | Wilson 1980 |
| `renin_term_ng_per_ml_per_h` | PRA at term | 12 | B | phase2 | Wilson 1980 |
| `homa_ir_term` | HOMA-IR at term | 4.0 | B | phase2 | Catalano 1991 |
| `homa_ir_baseline` | Non-pregnant HOMA-IR | 2.0 | B | phase2 | Catalano 1991 |
...
| `villous_capillary_length_total_km` | Total capillary length | 300 | C | phase2 | Mayhew 2014 |
| `intervillous_space_volume_term_ml` | IVS volume at term | 250 | B | phase2 | Mayhew 2014 |
...
| `maternal_fetal_pco2_gradient_mmhg` | mPCO₂ − fPCO₂ | 10 | B | phase2 | Carter 2009 |
...
| `maternal_fetal_glucose_gradient_mmol_per_l` | M-F glucose gradient | 1.5 | B | phase2 | Cleal 2008 |
| `transplacental_glucose_flux_mg_per_kg_per_min` | Net glucose flux | 5 | B | phase2 | Hay 2006 |
| `fetal_arterial_glucose_term_mmol_per_l` | UA glucose | 3.5 | B | phase2 | Battaglia 1986 |
...
| Parameter id | What | Typical | Tier | Status | Primary citation |
| --- | --- | --- | --- | --- | --- |
| `hcg_peak_miu_per_ml` | hCG peak | 100000 | A | phase2 | Cole 2010 |
| `hcg_peak_week` | Week of hCG peak | 10 | A | phase2 | Cole 2010 |
| `hcg_term_miu_per_ml` | hCG at term | 10000 | A | phase2 | Cole 2010 |
| `hpl_term_ug_per_ml` | hPL at term | 7 | B | phase2 | Handwerger 2010 |
| `progesterone_term_ng_per_ml` | Progesterone term | 150 | A | phase2 | Tulchinsky 1972 |
| `estradiol_term_ng_per_ml` | Estradiol term | 14 | A | phase2 | Tulchinsky 1972 |
...
| `umbilical_vein_flow_term_ml_per_min` | UV flow at term | 350 | B | phase2 | Kiserud 2001 |
| `umbilical_vein_flow_per_kg_term_ml_per_min_per_kg` | UV flow per kg | 115 | B | phase2 | Kiserud 2001 |
| `combined_ventricular_output_term_ml_per_min_per_kg` | CVO/kg | 450 | B | phase2 | Rudolph 1985 |
| `rv_output_fraction_term` | RV fraction of CVO | 0.65 | A | phase2 | Rudolph 1985 |
| `lv_output_fraction_term` | LV fraction of CVO | 0.35 | A | phase2 | Rudolph 1985 |
| `ductus_venosus_shunt_fraction_term` | DV shunt fraction | 0.30 | B | phase2 | Kiserud 2001 |
| `foramen_ovale_shunt_fraction_term` | FO shunt fraction | 0.30 | B | phase2 | Rudolph 1985 |
| `ductus_arteriosus_shunt_fraction_term` | DA shunt fraction | 0.55 | B | phase3 | Rudolph 1985 |
| `aortic_isthmus_flow_fraction_term` | Isthmus/CVO | 0.10 | C | phase3 | Sutton 1991 |
| `mca_flow_term_ml_per_min` | MCA flow term | 30 | C | phase3 | Mari 1995 |
| `fetal_heart_rate_t1_bpm` | FHR in T1 | 170 | A | phase2 | von Steinburg 2013 |
| `fetal_heart_rate_term_bpm` | FHR at term | 140 | A | phase2 | von Steinburg 2013 |
| `umbilical_artery_pi_term` | UA PI at term | 0.85 | B | phase3 | Acharya 2005 |
| `mca_pi_term` | MCA PI at term | 1.6 | C | phase3 | Mari 1995 |
...
| `efw_16w_g` | EFW at 16w | 145 | A | phase1 | Buck Louis 2015 |
| `efw_24w_g` | EFW at 24w | 650 | A | phase1 | Buck Louis 2015 |
| `efw_32w_g` | EFW at 32w | 1800 | A | phase1 | Buck Louis 2015 |
| `bpd_16w_mm` | BPD at 16w | 35 | A | phase1 | Buck Louis 2015 |
| `bpd_20w_mm` | BPD at 20w | 47 | A | phase1 | Buck Louis 2015 |
| `bpd_24w_mm` | BPD at 24w | 61 | A | phase1 | Buck Louis 2015 |
| `bpd_32w_mm` | BPD at 32w | 82 | A | phase1 | Buck Louis 2015 |
| `bpd_36w_mm` | BPD at 36w | 89 | A | phase1 | Buck Louis 2015 |
| `bpd_40w_mm` | BPD at 40w | 93 | A | phase1 | Buck Louis 2015 |
| `hc_16w_mm` | HC at 16w | 124 | A | phase1 | Buck Louis 2015 |
| `hc_20w_mm` | HC at 20w | 175 | A | phase1 | Buck Louis 2015 |
| `hc_24w_mm` | HC at 24w | 225 | A | phase1 | Buck Louis 2015 |
| `hc_28w_mm` | HC at 28w | 267 | A | phase1 | Buck Louis 2015 |
| `hc_32w_mm` | HC at 32w | 297 | A | phase1 | Buck Louis 2015 |
| `hc_36w_mm` | HC at 36w | 322 | A | phase1 | Buck Louis 2015 |
| `hc_40w_mm` | HC at 40w | 343 | A | phase1 | Buck Louis 2015 |
| `ac_16w_mm` | AC at 16w | 105 | A | phase1 | Buck Louis 2015 |
| `ac_20w_mm` | AC at 20w | 152 | A | phase1 | Buck Louis 2015 |
| `ac_24w_mm` | AC at 24w | 198 | A | phase1 | Buck Louis 2015 |
| `ac_28w_mm` | AC at 28w | 240 | A | phase1 | Buck Louis 2015 |
| `ac_32w_mm` | AC at 32w | 282 | A | phase1 | Buck Louis 2015 |
| `ac_36w_mm` | AC at 36w | 322 | A | phase1 | Buck Louis 2015 |
| `ac_40w_mm` | AC at 40w | 354 | A | phase1 | Buck Louis 2015 |
| `fl_16w_mm` | FL at 16w | 21 | A | phase1 | Buck Louis 2015 |
| `fl_20w_mm` | FL at 20w | 33 | A | phase1 | Buck Louis 2015 |
| `fl_24w_mm` | FL at 24w | 44 | A | phase1 | Buck Louis 2015 |
| `fl_32w_mm` | FL at 32w | 62 | A | phase1 | Buck Louis 2015 |
| `fl_36w_mm` | FL at 36w | 70 | A | phase1 | Buck Louis 2015 |
| `fl_40w_mm` | FL at 40w | 76 | A | phase1 | Buck Louis 2015 |
...
| `umbilical_artery_ph_term` | UA pH at term | 7.27 | A | phase2 | Westgren 1995 |
| `umbilical_vein_ph_term` | UV pH at term | 7.34 | A | phase2 | Westgren 1995 |
| `fetal_lactate_term_mmol_per_l` | Fetal lactate | 2.0 | B | phase2 | Westgren 1995 |
| `fetal_arterial_glucose_term_mmol_per_l` | (also in placental_glucose) | 3.5 | B | phase2 | Battaglia 1986 |
...
| `fetal_core_temperature_term_c` | Fetal core temp | 37.5 | B | phase3 | Asakura 2004 |
| `fetal_urine_output_term_ml_per_h` | Fetal urine output | 25 | B | phase2 | Rabinowitz 1989 |
...
| Parameter id | What | Typical | Tier | Status | Primary citation |
| --- | --- | --- | --- | --- | --- |
| `afv_peak_ml` | AFV peak volume | 800 | A | phase2 | Brace 1989 |
| `afv_peak_week` | Week of AFV peak | 33 | A | phase2 | Brace 1989 |
| `afv_term_ml` | AFV at term | 600 | A | phase2 | Brace 1989 |
| `afv_20w_ml` | AFV at 20w | 350 | A | phase2 | Brace 1989 |
...
The dataset already contains 33 citations. Filling the full catalog
above requires the additions below, by phase. Each must pass the
Crossref-metadata audit before merge.

### Phase 1 citations (~6 new)

- Kline 2005 — D-dimer in pregnancy
- Larsson 2008 — serum proteins in pregnancy
- Pitkin 1979 — WBC in pregnancy
...
- Cleal 2008 — placental glucose flux
- Hay 2006 — transplacental glucose
...
- Asakura 2004 — fetal temperature
